...
for sql in 01-schema.sql 02-agent-server.sql 07-hermes-autonomy.sql; do
...
pathlib.Path(sys.argv[1]).write_text(json.dumps({
 ...
 "denials":{"api_merge":True,"protected_push":True,"workflow_write":True,"deployment":True,"administration":True},
