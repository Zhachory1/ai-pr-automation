...
from hermes_pr_safety_result import run_usage, union_ledgers, valid_council_metadata
...
def valid_v2_metadata(metadata, role, ctx, lines):
    return valid_council_metadata(metadata, role, ctx["workflow_id"], ctx["artifact_digest"], lines)
