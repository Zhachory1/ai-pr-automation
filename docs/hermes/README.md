...
PR 4 performs one disposable-repository autonomy capability check before native credentials start.
...
`hermes-agent`, a disposable enrolled repository, GitHub credentials, fresh authority evidence, and
