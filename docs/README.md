...
- **[pr-safety-review.md](pr-safety-review.md)** — read-only Google Chat producer, draft-only
  immutable-SHA PR safety controller, and isolated analyst runner. No external write path exists.
